...
class ViewMedicalDetails extends Component {
    ...
    getReceptionList = async () => {
        let api = `${url}/api/prescription/recopinists/?clinic=${this.props.medical.clinicpk}`
        console.log(api)
    ...
    getClinicDetails = async()=>{
        let api = `${url}/api/prescription/clinics/${this.props.medical.clinicpk}/`
        console.log(api)
        const data =await HttpsClient.get(api)
        if(data.type =="success"){
        ...
        let api = `${url}/api/prescription/clinicImages/?clinic=${this.props.medical.clinicpk}`
        console.log(api)
