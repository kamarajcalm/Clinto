...
class CreateDiagnosticCenterOwner extends Component {
    constructor(props) {
        super(props);
        this.state = {
            showModal: false,
                    ...
                    <View style={{ flex: 1, }}>
                        ...
                        <View style={{ height: height * 0.1, backgroundColor: themeColor, borderBottomRightRadius: 20, borderBottomLeftRadius: 20, justifyContent: "center", flexDirection: "row" }}>
                            ...
                            <View style={{ flex: 0.6, alignItems: 'center', justifyContent: "center" }}>
                                <Text style={[styles.text, { color: "#fff" }]}>Create Lab Owner</Text>
                            </View>
...
export default connect(mapStateToProps, { selectTheme })(CreateDiagnosticCenterOwner)