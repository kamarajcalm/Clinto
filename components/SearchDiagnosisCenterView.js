...
const {url} =settings
 class SearchDiagnosisCenterView extends Component {
  constructor(props) {
    super(props)
 ...
 getClinics =async()=>{
     ...
     let api =`${url}/api/prescription/nearestClinic/?limit=10&offset=${this.state.offset}&lat=${location.lat}&long=${location.lng}&nearestLab=jjj`
...
export default connect(mapStateToProps, { selectTheme, selectClinic })(SearchDiagnosisCenterView)