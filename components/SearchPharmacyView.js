...
import { Text, TouchableOpacity, View ,StyleSheet, Dimensions,Linking,FlatList,Image} from 'react-native'
...
const {url} =settings
 class SearchPharmacyView extends Component {
  constructor(props) {
    super(props)
 ...
 getClinics =async()=>{
     ...
     let api =`${url}/api/prescription/nearestClinic/?limit=10&offset=${this.state.offset}&lat=${location.lat}&long=${location.lng}&nearestMedical=jjj`
...
export default connect(mapStateToProps, { selectTheme, selectClinic })(SearchPharmacyView)